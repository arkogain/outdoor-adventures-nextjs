...
const page = () => {
  return (
    <>
      ...
      <div className="">
        <div className="">
          <div className="text-2xl font-bold md:text-3xl lg:text-4xl">{`It's Time to Start Your Adventures`}</div>
          <div className="h-0.5 w-24 bg-rose-500"></div>
          ...
          <div className="">
            <div className="flex gap-3">
              <Minus color="#ff2056" /> Experience: Locavit liberioris possedit
            </div>
            <div className="flex gap-3">
              <Minus color="#ff2056" /> Experience: Locavit liberioris possedit
            </div>
